...
{{< cards >}}
  ...
  {{< card link="/docs/integrations/magento2" title="Magento 2" subtitle="Magento 2 plugin" tag="All-in-one" tagType="debug" >}}
{{< /cards >}}
...
{{< cards >}}
  ...
  {{< card link="/docs/integrations/java" title="Java" subtitle="Server-side Java library" tag="Server-side" tagType="info" >}}
